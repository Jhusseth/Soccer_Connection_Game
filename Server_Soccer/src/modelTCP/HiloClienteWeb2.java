...
public class HiloClienteWeb2 implements Runnable{
	private final Socket socket;

	public HiloClienteWeb2(Socket socket)
	{
		this.socket =  socket;
	}
			...
			if(headerLine!=null)
			{
				...
				if(httpMethod.equals("GET"))
				{
					...
					if(httpQueryString.equals("/"))
					{
						...
						String str="";
						BufferedReader buf = new BufferedReader(new FileReader(System.getProperty("user.dir") +"/html/game.html"));
					...
					if(httpQueryString.contains("/?matchSTD="))
					{
